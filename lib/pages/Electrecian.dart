...
class ElectrecianPage extends StatefulWidget {
  const ElectrecianPage({super.key});

  @override
  State<ElectrecianPage> createState() => _ElectrecianPageState();
}

class _ElectrecianPageState extends State<ElectrecianPage> {
  ...
  final List<_ProfessionalItem> _professionals = const [
    ...
    _ProfessionalItem(
      ...
      location: 'MEDEA',
      rating: 3.0,
      imagePath: 'assets/mohaelc.jpg',
    ),
    _ProfessionalItem(
      name: 'SALIM ELC',
      location: 'MILA',
      rating: 3.2,
      imagePath: 'assets/salim.png',
    ),
    _ProfessionalItem(
      name: 'AMIR ELC',
      location: 'BATNA',
      rating: 2.0,
      imagePath: 'assets/amir.png',
    ),
  ];
